          ...
          <div className="w-full md:w-3/4 lg:w-4/5 xl:w-3/4 bg-white rounded-lg shadow-md ">
            ...
            <div className="my-2 overflow-x-auto rounded-lg">
              <div className="flex justify-between">
                ...
                <Link to="/vales-ingresado" className="bg-white font-bold text-blue-900 border-2 border-blue-900  hover:bg-blue-500 hover:text-blue-50 w-full rounded-bl-lg rounded-tl-lg px-6 py-2 text-center block">Correlativo Ingresado Agencia</Link>
                </div>
...
export default ValesEntregadoPage