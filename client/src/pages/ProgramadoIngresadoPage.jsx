...
function ProgramadoIngresadoPage() {
  return (
      ...
      <div className="w-full md:w-3/4 lg:w-4/5 xl:w-3/4 bg-white rounded-lg shadow-md ">
        ...
        <div className="my-2 overflow-x-auto rounded-lg">
          <div className="flex justify-between">
            ...
            <Link to="" className="bg-blue-900 font-bold text-blue-50  hover:text-blue-50 border-2  border-blue-300  w-full rounded-tl-lg rounded-bl-lg px-6 py-2 text-center block">Correlativo Ingresado Agencia</Link>
            </div>
            <div className="flex-1 " style={{ marginRight: '50px' }}>
            <Link to="/programado-entregado" className="bg-white font-bold text-blue-900 border-2 border-blue-900  hover:bg-blue-500 hover:text-blue-50 w-full rounded-tr-lg rounded-br-lg px-6 py-2 text-center block">Correlativo Entregado Asociados</Link>
            </div>
          </div>
          <table className="w-full border-collapse rounded-lg mt-2">
            <thead>
              <tr >
                ...
                <th colSpan="5" className="py-3 text-center bg-blue-900 text-white rounded-t-lg">Correlativo Ingresado Agencia</th>
              </tr>
              <tr className="bg-blue-900 text-white">
                ...
                <th className="py-3 text-center px-8">Total Ingreso</th>
...
export default ProgramadoIngresadoPage