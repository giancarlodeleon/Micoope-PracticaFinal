...
function ProgramadoIngresadoPage() {
  ...
  const combinedMovimientos = filteredMovimientos.filter((movimiento) => {
    if (Setpermiso) {
      ...
      return movimiento.tipo === "Programado" && movimiento.agencia === selectedAgencia;
    } else {
      // Mostrar los movimientos filtrados según el usuario si Setpermiso es false
      return movimiento.tipo === "Programado" && movimiento.agencia === user.agencia;
    }
  });
      ...
      <div className="w-full md:w-3/4 lg:w-4/5 xl:w-3/4 bg-white rounded-lg shadow-md">
        ...
        <div className="flex justify-center items-center mt-4">
          <p className="text-lg font-semibold text-blue-900">
            Total de Saldos Disponible: {totalSaldo-totalUsado}
          </p>
          {totalSaldo <= 50 && (
            <span
