...
function BoletasTRXEntregadoPage() {
  ...
  useEffect(() => {
    ...
    const filteredSalidas = salidas.filter((salida) => {
      ...
      if (selectedAgency) {
        return salida.agencia === selectedAgency && salida.tipo === "Boletas TRX";
      } else {
        return (!Setpermiso && salida.agencia === user.agencia && salida.tipo === "Boletas TRX");
      }
    });
...
export default BoletasTRXEntregadoPage