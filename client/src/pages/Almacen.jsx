                ...
                <tr key={boleta._id}>
                  ...
                  <td className="text-center border border-blue-100">
                    <div className="flex items-center justify-center">
                      <span className="mr-1" style={{ verticalAlign: "middle" }} title={boleta.existencia <= 50 ? "Queda poca existencia" : ""}>
                        {boleta.existencia}
                      </span>
                      {boleta.existencia <= 50 && <span className="text-red-500" style={{ verticalAlign: "middle" }} title="Queda poca existencia, recomendado solicitar mas">⚠️</span>}
                    </div>
                  </td>
